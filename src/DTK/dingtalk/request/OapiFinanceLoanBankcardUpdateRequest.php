<?php
/**
 * dingtalk API: dingtalk.oapi.finance.loan.bankcard.update request
 * 
 * @author auto create
 * @since 1.0, 2021.01.18
 */
class OapiFinanceLoanBankcardUpdateRequest
{
	/** 
	 * 银行编码
	 **/
	...
	public function setBankcardId($bankcardId)
	{
		...
		$this->apiParas["bankcard_id"] = $bankcardId;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->bankcardId,"bankcardId");
